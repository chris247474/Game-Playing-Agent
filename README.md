...
You may write or modify code within each file (but you must maintain compatibility with the function signatu**r**es provided).  You may add other classes, functions, etc., as needed, but it is not required.
